<template>
  <div class="page-rule-my-update">
    <div class="page-rule-my-update-breadcrumb-box" v-if="breadcrumbData && breadcrumbData.length > 0">
      <art-breadcrumb :data="breadcrumbData"></art-breadcrumb>
    </div>
    <div class="page-rule-my-update-title row no-gutter flex-between">
      <h3>{{this.type === 'add' ? '添加规则' : '编辑规则'}}</h3>
    </div>
    <div class="page-rule-my-update-cont">
    ...
    <div class="page-rule-my-update-btn">
  ...
  export default {
      ...
      if (this.type === 'add') {
        ...
        if (this.ruleId) {
          ...
          this.$router.replace({path: '/rule/my'})
        }
      } else {
        this.$router.replace({path: '/rule/my'})
      }
...
<style type="text/scss" lang="scss">
  ...
  .page-rule-my-update { padding: 0 30px;
